...
ncnn_mobilenetssd::~ncnn_mobilenetssd() {
//    if(m_mobilenet != NULL)
//        delete m_mobilenet;
    m_mobilenet.clear();
}

void ncnn_mobilenetssd::Init(){
...
int ncnn_mobilenetssd::Detect(cv::Mat& bgr, std::vector<Object>& objects)
{
...
int ncnn_mobilenetssd::Detect_draw(cv::Mat &bgr) {
...
int main(int argc, char** argv)
{
    ...
    ncnn_mobilenetssd MobilenetSSD;
    MobilenetSSD.Init();
